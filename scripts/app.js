...
function clickOnCard(e) {
  ...
  while (elem.parentNode) {
    ...
    var opened = document.querySelectorAll(".article__card.open");
...
var eventHandlers = require("./handlers").handlers;

var $ = require("jquery");
var slick = require("slick-carousel/slick/slick.min.js");
